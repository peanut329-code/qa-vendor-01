...
export const EVALUATIONS: Evaluation[] = [
  // --- SUP-001 品晶半導體材料 ---
  {
    ...
    period: "2026-Q2",
    status: "approved", total_score: 94.55, tier: "A",
  ...
  },
  {
    ...
    evaluator_id: "u5", evaluator_name: "李美玲",
    period: "2026-Q1",
    status: "approved", total_score: 92.15, tier: "A",
  ...
  // --- SUP-002 正鑫特殊氣體 ---
  {
    ...
    period: "2026-Q2",
    status: "approved", total_score: 93.55, tier: "A",
  ...
  },
  {
    ...
    evaluator_id: "u6", evaluator_name: "張偉誠",
    period: "2026-Q1",
    status: "approved", total_score: 90.95, tier: "A",
  ...
  },
  {
    ...
    evaluator_id: "u5", evaluator_name: "李美玲",
    period: "2026-Q1",
    status: "approved", total_score: 82.60, tier: "B",
  ...
  },
  {
    ...
    evaluator_id: "u6", evaluator_name: "張偉誠",
    period: "2026-Q1",
    status: "approved", total_score: 80.20, tier: "B",
  ...
  },
  {
    ...
    evaluator_id: "u6", evaluator_name: "張偉誠",
    period: "2026-Q1",
    status: "approved", total_score: 65.40, tier: "C",
...
export const EVALUATION_SCORES: Record<string, EvaluationScore[]> = {
  // e1 — 品晶半導體 Q1-2025  total ≈ 94.55
  e1: [
    { criteria_id: "c1", criteria_name: "品質合格率",   category: "品質", weight: 30, score: 95, weighted_score: 28.5, notes: "矽晶圓 TTV 均一性 ≤ 1.5μm，批退率 0.3%，表現優異" },
    { criteria_id: "c2", criteria_name: "交貨準時率",   category: "交期", weight: 25, score: 97, weighted_score: 24.25, notes: "準時交貨率 99.2%，緊急備貨回應迅速" },
    { criteria_id: "c3", criteria_name: "價格競爭力",   category: "價格", weight: 20, score: 90, weighted_score: 18.0, notes: "年降價 2%，報價合理且透明" },
    { criteria_id: "c6", criteria_name: "品質管理系統", category: "品質", weight: 15, score: 94, weighted_score: 14.1, notes: "IATF 16949 認證有效，SPC 全面導入" },
    { criteria_id: "c8", criteria_name: "環保合規性",   category: "合規", weight: 10, score: 97, weighted_score: 9.7, notes: "ISO 14001 認證，廢水排放達標" },
  ],
  // e2 — 品晶半導體 Q4-2024  total ≈ 92.15
  e2: [
    { criteria_id: "c1", criteria_name: "品質合格率",   category: "品質", weight: 30, score: 93, weighted_score: 27.9, notes: "12吋晶圓缺陷密度 ≤ 0.08 個/cm²" },
    { criteria_id: "c2", criteria_name: "交貨準時率",   category: "交期", weight: 25, score: 94, weighted_score: 23.5, notes: "Q4 準時交貨率 98.5%" },
    { criteria_id: "c3", criteria_name: "價格競爭力",   category: "價格", weight: 20, score: 88, weighted_score: 17.6, notes: "年降價 1.8%，合約執行穩定" },
    { criteria_id: "c6", criteria_name: "品質管理系統", category: "品質", weight: 15, score: 91, weighted_score: 13.65, notes: "SPC 管制圖完整，Cpk ≥ 1.67" },
    { criteria_id: "c8", criteria_name: "環保合規性",   category: "合規", weight: 10, score: 95, weighted_score: 9.5, notes: "碳盤查報告完整，ESG 達標" },
  ],
  // e3 — 正鑫特殊氣體 Q1-2025  total ≈ 93.55
  e3: [
    { criteria_id: "c1", criteria_name: "品質合格率",   category: "品質", weight: 30, score: 96, weighted_score: 28.8, notes: "NF₃ 純度 ≥ 99.9999%，批次均一性優" },
    { criteria_id: "c2", criteria_name: "交貨準時率",   category: "交期", weight: 25, score: 94, weighted_score: 23.5, notes: "緊急補貨 ≤ 4h，準時率 98.8%" },
    { criteria_id: "c3", criteria_name: "價格競爭力",   category: "價格", weight: 20, score: 88, weighted_score: 17.6, notes: "長約鎖價，氣體成本波動控制良好" },
    { criteria_id: "c6", criteria_name: "品質管理系統", category: "品質", weight: 15, score: 93, weighted_score: 13.95, notes: "ISO 45001 安衛認證有效" },
    { criteria_id: "c8", criteria_name: "環保合規性",   category: "合規", weight: 10, score: 97, weighted_score: 9.7, notes: "危險物品運輸 SOP 完善，無事故記錄" },
  ],
  // e4 — 正鑫特殊氣體 Q4-2024  total ≈ 90.95
  e4: [
    { criteria_id: "c1", criteria_name: "品質合格率",   category: "品質", weight: 30, score: 91, weighted_score: 27.3, notes: "氣體純度穩定，無重大批退紀錄" },
    { criteria_id: "c2", criteria_name: "交貨準時率",   category: "交期", weight: 25, score: 93, weighted_score: 23.25, notes: "Q4 準時交貨率 97.2%" },
    { criteria_id: "c3", criteria_name: "價格競爭力",   category: "價格", weight: 20, score: 87, weighted_score: 17.4, notes: "年降價 1.5%，合理範圍" },
    { criteria_id: "c6", criteria_name: "品質管理系統", category: "品質", weight: 15, score: 90, weighted_score: 13.5, notes: "ISO 45001 在效，SPC 管制正常" },
    { criteria_id: "c8", criteria_name: "環保合規性",   category: "合規", weight: 10, score: 95, weighted_score: 9.5, notes: "廢氣處理合規，符合法規要求" },
  ],
  // e5 — 光揚光罩科技 Q1-2025  total ≈ 85.15
  e5: [
    { criteria_id: "c1", criteria_name: "品質合格率",   category: "品質", weight: 30, score: 87, weighted_score: 26.1, notes: "DUV 光罩 CD 精度 ±3nm，良率 97.5%" },
    { criteria_id: "c2", criteria_name: "交貨準時率",   category: "交期", weight: 25, score: 80, weighted_score: 20.0, notes: "交期延誤 2 次，共延遲 8 工作天，需改善" },
    { criteria_id: "c3", criteria_name: "價格競爭力",   category: "價格", weight: 20, score: 85, weighted_score: 17.0, notes: "報價合理，但年降不足 1%" },
    { criteria_id: "c6", criteria_name: "品質管理系統", category: "品質", weight: 15, score: 87, weighted_score: 13.05, notes: "ISO 9001 認證有效，SPC 部分導入" },
    { criteria_id: "c8", criteria_name: "環保合規性",   category: "合規", weight: 10, score: 90, weighted_score: 9.0, notes: "環保合規，廢液處理符合標準" },
  ],
  // e6 — 光揚光罩科技 Q4-2024  total ≈ 82.60
  e6: [
    { criteria_id: "c1", criteria_name: "品質合格率",   category: "品質", weight: 30, score: 84, weighted_score: 25.2, notes: "光罩缺陷修補率 95%，品質穩定" },
    { criteria_id: "c2", criteria_name: "交貨準時率",   category: "交期", weight: 25, score: 79, weighted_score: 19.75, notes: "交期略有延誤，改善行動進行中" },
    { criteria_id: "c3", criteria_name: "價格競爭力",   category: "價格", weight: 20, score: 82, weighted_score: 16.4, notes: "報價合理性普通，議價空間有限" },
  ...
  e8: [
    ...
    { criteria_id: "c3", criteria_name: "價格競爭力",   category: "價格", weight: 20, score: 78, weighted_score: 15.6, notes: "價格競爭力普通，高於市場均價 5%" },
  ...
  e10: [
    ...
    { criteria_id: "c3", criteria_name: "價格競爭力",   category: "價格", weight: 20, score: 70, weighted_score: 14.0, notes: "報價高於市場均價，年降承諾未履行" },
    { criteria_id: "c6", criteria_name: "品質管理系統", category: "品質", weight: 15, score: 68, weighted_score: 10.2, notes: "SPC 管制導入率僅 40%，遠低於要求" },
    { criteria_id: "c8", criteria_name: "環保合規性",   category: "合規", weight: 10, score: 52, weighted_score: 5.2, notes: "廢液處理未達標，已接獲環保局警告" },
  ],
};
...
export const SCARS: Scar[] = [
  ...
  },
  {
    ...
    triggered_tier: "B",
    issue_description: "Q4 交期延誤 2 次，延誤時間分別為 5 天及 3 天，超出合約允許的 1 個工作天緩衝，直接影響 company 公司晶圓投片計畫。",
    category: "交期",
...
export const ASL_RECORDS: AslRecord[] = [
  {
    ...
    status: "approved",
    approved_by: "王建國",
    approved_date: "2025-06-30",
    valid_until: "2028-06-29",
